...
urlpatterns = [
    ...
    path('product/<uuid:id>/review/',write_review_view, name='product-review' ),
    path('product/search/', product_search_view, name='product-search'),
    path('shop/by/<str:str>/', shop_by_category, name='shop-by-category'),
    path('product/<uuid:id>/add-to-cart/', add_to_cart_view, name='add-to-cart'),
    path('my/cart/', cart_view, name='product-cart'),
    path('update/<str:id>/quantity/', update_cart_view, name='update-cart'),
